...
export const useUpdateArticleMeta = (id: string) =>
  useMutation<UpdateArticleMetaData, Error, Record<string, any>>((values) =>
    appFetch({
...
export const useUpdateArticleGeneral = (id: string) =>
  useMutation<UpdateArticleGeneral, Error, BodyInit>((values) =>
    appFetch({
...
export const useUpdateArticleStatus = (id: string) =>
  useMutation<{ status: ArticleStatus }, Error, Record<string, any>>((values) =>
    appFetch({
