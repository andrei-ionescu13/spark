...
import { Box, Card, CardContent, CardHeader, Divider, Grid, IconButton } from '@mui/material';
...
export const ProductGeneral: FC<ProductGeneralProps> = (props) => {
  ...
  const [previewSelected, setPreviewSelected] = useState<'minimumRequirements' | 'recommendedRequirements' | 'markdown' | undefined>();
          ...
          >
            ...
            >
              <InfoList>
                ...
                <InfoListItem
                  title="Developer"
                  content={product.developers.join(', ')}
                  type="line"
                />
                <InfoListItem
                  title="Languages"
                  content={product.languages.join(', ')}
                  type="line"
                />
                <InfoListItem
                  title="Features"
