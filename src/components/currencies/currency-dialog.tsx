...
const isCurrencyOptionKey = (x: any): x is CurrencyOptionKey => currencyOptionKeys.includes(x);
...
export const CurrencyDialog: FC<CurrencyDialogProps> = (props) => {
  ...
  const createCurrency = useCreateCurrency(() => queryClient.invalidateQueries('currencies'));
